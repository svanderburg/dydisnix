...
{
    NixXML_print_g_hash_table_nix(file, id_assignments_table, indent_level, userdata, (NixXML_PrintValueFunc)NixXML_print_int_nix);
}
...
{
    NixXML_print_g_hash_table_verbose_xml(file, id_assignments_table, "assignment", "name", indent_level, NULL, userdata, (NixXML_PrintXMLValueFunc)NixXML_print_int_xml);
}
