...
static void print_usage(char *command)
{
    ...
    fprintf(stderr, "%s --services-xml services.xml --infrastructure-xml infrastructure.xml --distribution-xml distribution.xml --service-property serviceProperty\n", command);
...
int main(int argc, char *argv[])
{
    ...
    /* Execute operation */
    portassign(services_xml, infrastructure_xml, distribution_xml, service_property);
    return 0;
}
