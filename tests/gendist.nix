...
simpleTest {
  ...
  testScript =
    ...
    ''
      ...
      my $result = $machine->mustSucceed("${env} dydisnix-gendist --filter-buildable -s ${models}/services.nix -i ${models}/infrastructure.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist --filter-buildable -s ${models}/services-error.nix -i ${models}/infrastructure.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-mapattronattr.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-mapattronlist.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-maplistonattr.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-order.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-greedy.nix --output-xml");
      ...
      $machine->mustFail("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure-undercapacity.nix -q ${models}/qos/qos-greedy.nix");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-highest-bidder.nix --output-xml");
      ...
      # Execute the same division method again. It should fail because the machines cannot provide its required capacity.
      $machine->mustFail("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure-undercapacity.nix -q ${models}/qos/qos-highest-bidder.nix");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-lowest-bidder.nix --output-xml");
      ...
      # Execute the same division method again. It should fail because the machines cannot provide its required capacity.
      $machine->mustFail("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure-undercapacity.nix -q ${models}/qos/qos-lowest-bidder.nix");

      # Execute round robin division method.
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-roundrobin.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-minsetcover.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-minsetcover2.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-multiwaycut.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure-3.nix -q ${models}/qos/qos-graphcol.nix --output-xml");
      ...
      $result = $machine->mustFail("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-graphcol.nix --output-xml");
      ...
      my $firstTargets = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-firsttargets.nix");
      $result = $machine->mustSucceed("${env} disnix-manifest -s ${models}/services.nix -i ${models}/infrastructure.nix -d $firstTargets");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-mapstatefultoprevious.nix --output-xml");
      ...
      $firstTargets = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-firsttargets.nix");
      $result = $machine->mustSucceed("${env} disnix-manifest -s ${models}/services.nix -i ${models}/infrastructure.nix -d $firstTargets");
      $machine->mustSucceed("nix-env -p /nix/var/nix/profiles/per-user/root/disnix-coordinator/default --set $result");

      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -q ${models}/qos/qos-mapboundservicestoprevious.nix --output-xml");
      ...
      $result = $machine->mustSucceed("${env} dydisnix-gendist -s ${models}/services.nix -i ${models}/infrastructure.nix -F ${models}/qos/customfilters.nix -q ${models}/qos/qos-clear.nix");
    '';
}
